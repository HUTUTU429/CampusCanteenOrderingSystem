    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('canteen_photo', models.ImageField(blank=True, null=True, upload_to='images/canteen', verbose_name='食堂照片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('canteen', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canteen.canteen', verbose_name='食堂')),
                ('manager', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='canteen.shopmanager', verbose_name='窗口经营者')),
            ],
            options={
                'verbose_name': '窗口信息',
